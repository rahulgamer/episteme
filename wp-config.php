...
/**
	LDAP configurations
**/
define('LDAP_SERVER', "LDAP://10.237.5.185");
define('LDAP_PORT', "389");
define('LDAP_BASEDN', 'dc=cts,dc=com');
define('LDAP_AUTHREALM', 'My CTS');
define('LDAP_USER_FILTER', 'SAMAccountName');

/**
	Define login error messages
	
**/
define('INVALID', 'Invalid Credentials');
define('NOTCOE', 'You cannot Login to the system as doesn\'t belong to QE&A Technology CoE');
