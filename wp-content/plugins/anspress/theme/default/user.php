		...
		<div class="ap-profile-head clearfix">
			<div class="ap-user-image">
				...
				<?php 	
					...
					if($user_id != 'admin'){
						$user_details = ldap_user_details($user_id);
						echo '<img alt="" src="'. $user_details['image'].'" class="avatar avatar-105 photo" height="105" width="105">';
					} else {						
						echo get_avatar( $user->user_email, 105 );
					}
				?>
				</div>
			</div>
