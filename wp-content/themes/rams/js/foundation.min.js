    ...
    Foundation.libs.slider = {
        ...
        calculate_position: function (t, n) {
            ...
            requestAnimationFrame(function () {
                var e;
                Foundation.rtl && !i.vertical ? e = r.limit_to((a + u - n) / u, 0, 1)  : e = r.limit_to((n - a) / u, 0, 1),
                e = i.vertical ? 1 - e : e;
        ...
        set_ui: function (t, n) {
            ...
            u = o * (s - i) - 1,
            a = o * 100;
            Foundation.rtl && !r.vertical && (u = - u),
            u = r.vertical ? - u + s - i + 1 : u,
            this.set_translate(t, u, r.vertical),
            r.vertical ? t.siblings('.range-slider-active-segment').css('height', a + '%')  : t.siblings('.range-slider-active-segment').css('width', a + '%'),
            t.parent().attr(this.attr_name(), n).trigger('change').trigger('change.fndtn.slider'),
            t.parent().children('input[type=hidden]').val(n),
            r.input_id != '' && e(r.display_selector).each(function () {
        ...
        initialize_settings: function (t) {
            var n = e.extend({
            }, this.settings, this.data_options(e(t).parent()));
            n.vertical ? (e.data(t, 'bar_o', e(t).parent().offset().top), e.data(t, 'bar_l', e(t).parent().outerHeight()), e.data(t, 'handle_o', e(t).offset().top), e.data(t, 'handle_l', e(t).outerHeight()))  : (e.data(t, 'bar_o', e(t).parent().offset().left), e.data(t, 'bar_l', e(t).parent().outerWidth()), e.data(t, 'handle_o', e(t).offset().left), e.data(t, 'handle_l', e(t).outerWidth())),
        ...
        reflow: function () {
            ...
            t.S('[' + this.attr_name() + ']').each(function () {
                ...
                t.initialize_settings(n),
                r ? t.set_ui(e(n), parseFloat(r))  : t.set_initial_position(e(this))
            })
        }
    }
}(jQuery, window, window.document),
function (e, t, n, r) {
    ...
    Foundation.libs.joyride = {
        ...
        button_text: function (t) {
            return this.settings.next_button ? (t = e.trim(t) || 'Next', t = e(this.settings.template.button).append(t) [0].outerHTML)  : t = '',
            t
        },
        create: function (t) {
        ...
        set_li: function (e) {
            e ? (this.settings.$li = this.settings.$tip_content.eq(this.settings.start_offset), this.set_next_tip(), this.settings.$current_tip = this.settings.$next_tip)  : (this.settings.$li = this.settings.$li.next(), this.set_next_tip()),
            this.set_target()
        },
        ...
        pos_default: function (e) {
            ...
            if (!/body/i.test(this.settings.$target.selector)) {
                ...
                }), this.nub_position(t, this.settings.tip_settings.nub_position, 'right')),
        ...
        expose: function () {
            ...
            if (i.length < 1) return t.console && console.error('element not valid', i),
            !1;
        ...
        un_expose: function () {
            ...
            if (r.length < 1) return t.console && console.error('element not valid', r),
            !1;
            n = r.data('expose'),
            i = e('.' + n),
        ...
        startTimer: function () {
            ...
            if (typeof t == 'undefined' || t === !1) this.settings.post_step_callback(this.settings.$li.index(), this.settings.$current_tip),
...
function (e, t, n, r) {
    ...
    Foundation.libs.equalizer = {
        ...
        equalize: function (t) {
            ...
            t.trigger('before-height-change').trigger('before-height-change.fndth.equalizer'),
            r.height('inherit'),
            r.each(function () {
                var t = e(this);
                t.offset().top !== s && (n = !0)
            ...
            t.trigger('after-height-change').trigger('after-height-change.fndtn.equalizer')
        },
        reflow: function () {
            var t = this;
    ...
    Foundation.libs.dropdown = {
        ...
        events: function (n) {
            ...
            i(this.scope).off('.dropdown').on('click.fndtn.dropdown', '[' + this.attr_name() + ']', function (t) {
                ...
                if (!n.is_hover || Modernizr.touch) t.preventDefault(),
                r.toggle(e(this))
                ...
                t.data(r.data_attr()) ? (n = i('#' + t.data(r.data_attr())), s = t)  : (n = t, s = i('[' + r.attr_name() + '=\'' + n.attr('id') + '\']'));
                var o = s.data(r.attr_name(!0) + '-init') || r.settings;
                i(e.target).data(r.data_attr()) && o.is_hover && r.closeall.call(r),
        ...
        close: function (e) {
            var t = this;
            e.each(function () {
                t.S(this).hasClass(t.settings.active_class) && (t.S(this).css(Foundation.rtl ? 'right' : 'left', '-99999px').removeClass(t.settings.active_class).prev('[' + t.attr_name() + ']').removeClass(t.settings.active_class).removeData('target'), t.S(this).trigger('closed').trigger('closed.fndtn.dropdown', [
                    e
                ]))
            })
        },
        ...
        open: function (e, t) {
            ...
            e.data('target', t.get(0)).trigger('opened').trigger('opened.fndtn.dropdown', [
                e,
                t
            ])
        },
        ...
        toggle: function (e) {
            ...
            t.hasClass(this.settings.active_class) ? (this.close.call(this, t), t.data('target') !== e.get(0) && this.open.call(this, t, e))  : this.open.call(this, t, e)
        },
        resize: function () {
        ...
        adjust_pip: function (e, t) {
            ...
            this.small() && (e += t.left - 8),
            this.rule_idx = n.cssRules.length;
            var r = '.f-dropdown.open:before',
            i = '.f-dropdown.open:after',
            s = 'left: ' + e + 'px;',
            o = 'left: ' + (e - 1) + 'px;';
            n.insertRule ? (n.insertRule([r,
            '{',
            s,
            '}'].join(' '), this.rule_idx), n.insertRule([i,
            '{',
            o,
            '}'].join(' '), this.rule_idx + 1))  : (n.addRule(r, s, this.rule_idx), n.addRule(i, o, this.rule_idx + 1))
        },
        clear_idx: function () {
...
function (e, t, n, r) {
    ...
    s = function (i, s) {
        ...
        f.update_slide_number = function (t) {
            s.slide_number && (h.find('span:first').text(parseInt(t) + 1), h.find('span:last').text(f.slides().length)),
            s.bullets && (p.children().removeClass(s.bullets_active_class), e(p.children().get(t)).addClass(s.bullets_active_class))
        },
        ...
        f.build_markup = function () {
            ...
            s.navigation_arrows && (l.append(e('<a href="#"><span></span></a>').addClass(s.prev_class)), l.append(e('<a href="#"><span></span></a>').addClass(s.next_class))),
            s.timer && (d = e('<div>').addClass(s.timer_container_class), d.append('<span>'), d.append(e('<div>').addClass(s.timer_progress_class)), d.addClass(s.timer_paused_class), l.append(d)),
            s.slide_number && (h = e('<div>').addClass(s.slide_number_class), h.append('<span></span> ' + s.slide_number_text + ' <span></span>'), l.append(h)),
            s.bullets && (p = e('<ol>').addClass(s.bullets_container_class), l.append(p), p.wrap('<div class="orbit-bullets-container"></div>'), f.slides().each(function (t, n) {
        ...
        f.init = function () {
            f.build_markup(),
            s.timer && (g = f.create_timer(), Foundation.utils.image_loaded(this.slides().children('img'), g.start)),
            m = new a(s, c),
            s.animation === 'slide' && (m = new u(s, c)),
            l.on('click', '.' + s.next_class, f.next),
            l.on('click', '.' + s.prev_class, f.prev),
            s.next_on_click && l.on('click', '.' + s.slides_container_class + ' [data-orbit-slide]', f.link_bullet),
...
function (e, t, n, r) {
    ...
    Foundation.libs.offcanvas = {
        ...
        events: function () {
            ...
            r = '',
            i = '';
            this.settings.open_method === 'move' ? (n = 'move-', r = 'right', i = 'left')  : this.settings.open_method === 'overlap' && (n = 'offcanvas-overlap'),
            t(this.scope).off('.offcanvas').on('click.fndtn.offcanvas', '.left-off-canvas-toggle', function (t) {
                ...
                r && e.click_remove_class(t, n + r)
            })
        },
        toggle: function (e, t) {
            t = t || this.get_wrapper(),
            t.is('.' + e) ? this.hide(e, t)  : this.show(e, t)
        },
        show: function (e, t) {
            t = t || this.get_wrapper(),
        ...
        get_wrapper: function (e) {
            ...
            return t.length === 0 && (t = this.S('.off-canvas-wrap')),
            t
        },
        reflow: function () {
        }
...
function (e, t, n, r) {
    ...
    Foundation.libs['magellan-expedition'] = {
        ...
        events: function () {
            ...
            r(n.scope).off('.magellan').on('click.fndtn.magellan', '[' + n.add_namespace('data-magellan-arrival') + '] a[href^="#"]', function (t) {
                t.preventDefault();
        ...
        set_expedition_position: function () {
            ...
            e('[' + this.attr_name() + '=fixed]', t.scope).each(function (n, r) {
                ...
                u;
                i.attr('style', ''),
                u = i.offset().top + s.threshold,
                i.data(t.data_attr('magellan-top-offset'), u),
                i.attr('style', o)
            })
        },
        update_expedition_positions: function () {
            ...
            e('[' + this.attr_name() + '=fixed]', n.scope).each(function () {
                ...
                if (r >= s) {
                    ...
                    o.length === 0 && (o = t.clone(), o.removeAttr(n.attr_name()), o.attr(n.add_namespace('data-magellan-expedition-clone'), ''), t.before(o)),
                    t.css({
                        position: 'fixed',
                        top: i.fixed_top
                    })
                } else t.prev('[' + n.add_namespace('data-magellan-expedition-clone') + ']').remove(),
                t.attr('style', '').removeClass('fixed')
            })
        },
            ...
            e('[' + this.attr_name() + ']', n.scope).each(function () {
                ...
                s.each(function (e, r) {
                    if (r.viewport_offset >= r.top_offset) {
                        ...
                        return s.not(r.arrival).removeClass(i.active_class),
                        r.arrival.addClass(i.active_class),
                        u = !0,
                        !0
                    }
                }),
    ...
    Foundation.libs.accordion = {
        ...
        events: function () {
            ...
            n(this.scope).off('.fndtn.accordion').on('click.fndtn.accordion', '[' + this.attr_name() + '] > dd > a', function (r) {
                ...
                r.preventDefault(),
                i.attr(t.attr_name()) && (o = o.add('[' + a + '] dd > .content'), u = u.add('[' + a + '] dd'));
                if (f.toggleable && s.is(l)) {
                    s.parent('dd').toggleClass(f.active_class, !1),
                    s.toggleClass(f.active_class, !1),
                    f.callback(s),
                    s.triggerHandler('toggled', [
                        i
                    ]),
                    i.triggerHandler('toggled', [
                        s
                    ]);
                    return
                }
                f.multi_expand || (o.removeClass(f.active_class), u.removeClass(f.active_class)),
                s.addClass(f.active_class).parent().addClass(f.active_class),
                f.callback(s),
                s.triggerHandler('toggled', [
                    i
                ]),
    ...
    Foundation.libs.topbar = {
        ...
        init: function (t, n, r) {
            ...
            i.S('[' + this.attr_name() + ']', this.scope).each(function () {
                ...
                t.data('index', 0);
                var s = t.parent();
                s.hasClass('fixed') || i.is_sticky(t, s, n) ? (i.settings.sticky_class = n.sticky_class, i.settings.sticky_topbar = t, t.data('height', s.outerHeight()), t.data('stickyoffset', s.offset().top))  : t.data('height', t.outerHeight()),
                ...
                s.hasClass('fixed') && i.S('body').addClass('f-topbar-fixed')
            })
        },
        ...
        toggle: function (n) {
            ...
            r.breakpoint() && (r.rtl ? (o.css({
                ...
                left: '100%'
            })), r.S('li.moved', o).removeClass('moved'), i.data('index', 0), i.toggleClass('expanded').css('height', '')),
            s.scrolltop ? i.hasClass('expanded') ? i.parent().hasClass('fixed') && (s.scrolltop ? (i.parent().removeClass('fixed'), i.addClass('fixed'), r.S('body').removeClass('f-topbar-fixed'), t.scrollTo(0, 0))  : i.parent().removeClass('expanded'))  : i.hasClass('fixed') && (i.parent().addClass('fixed'), i.removeClass('fixed'), r.S('body').addClass('f-topbar-fixed'))  : (r.is_sticky(i, i.parent(), s) && i.parent().addClass('fixed'), i.parent().hasClass('fixed') && (i.hasClass('expanded') ? (i.addClass('fixed'), i.parent().addClass('expanded'), r.S('body').addClass('f-topbar-fixed'))  : (i.removeClass('fixed'), i.parent().removeClass('expanded'), r.update_sticky_positioning())))
        },
        timer: null,
        events: function (n) {
            var r = this,
            ...
            i(this.scope).off('.topbar').on('click.fndtn.topbar', '[' + this.attr_name() + '] .toggle-topbar', function (e) {
                ...
                n.hasClass('hover') ? (n.removeClass('hover').find('li').removeClass('hover'), n.parents('li.hover').removeClass('hover'))  : (n.addClass('hover'), e(n).siblings().removeClass('hover'), s[0].nodeName === 'A' && s.parent().hasClass('has-dropdown') && t.preventDefault())
            ...
            i('body').off('.topbar').on('click.fndtn.topbar touchstart.fndtn.topbar', function (e) {
        ...
        assembled: function (t) {
            t.data(this.attr_name(!0), e.extend({
    ...
    Foundation.libs.tab = {
        ...
        events: function () {
            ...
            n(this.scope).off('.tab').on('click.fndtn.tab', '[' + this.attr_name() + '] > * > a', function (t) {
                ...
                if (!r.is_hover || Modernizr.touch) t.preventDefault(),
                t.stopPropagation(),
                e.toggle_active_tab(n(this).parent())
        ...
        toggle_active_tab: function (n, i) {
            ...
            if (c.deep_linking) {
                ...
                c.scroll_to_content ? i == r || i == a ? n.parent() [0].scrollIntoView()  : s(a) [0].scrollIntoView()  : (i == r || i == a) && e('body,html').scrollTop(h)
            }
            ...
            c.callback(n),
            f.triggerHandler('toggled', [
                n
            ]),
            o.triggerHandler('toggled', [
                f
            ])
        },
        data_attr: function (e) {
...
function (e, t, n, r) {
    ...
    Foundation.libs.abide = {
        ...
        events: function (t) {
            ...
            r.off('.abide').on('submit.fndtn.abide validate.fndtn.abide', function (e) {
        ...
        reset: function (t) {
            ...
            e('.error', t).not('small').removeClass('error')
        },
        validate: function (e, t, n) {
            ...
            for (var a = 0; a < i; a++) if (!r[a] && (u || n)) return o.focus_on_invalid && e[a].focus(),
            s.trigger('invalid').trigger('invalid.fndtn.abide'),
            this.S(e[a]).closest('[data-' + this.attr_name(!0) + ']').attr(this.invalid_attr, ''),
            !1;
            return (u || n) && s.trigger('valid').trigger('valid.fndtn.abide'),
        ...
        valid_checkbox: function (e, t) {
            var e = this.S(e),
            n = e.is(':checked') || !t;
            return n ? e.removeAttr(this.invalid_attr).parent().removeClass('error')  : e.attr(this.invalid_attr, '').parent().addClass('error'),
            n
        },
        ...
        valid_equal: function (e, t, r) {
            ...
            s = e.value,
            o = i === s;
            return o ? (this.S(e).removeAttr(this.invalid_attr), r.removeClass('error'))  : (this.S(e).attr(this.invalid_attr, ''), r.addClass('error')),
            o
        },
